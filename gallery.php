...
<head>
        <!-- meta tag -->
        <meta charset="utf-8">
        <title>Netaji Subhas Public School - Gallery</title>
...
<div class="col-md-5 col-sm-12">
                                <div class="logo-area text-center">
                                    <a href="index.php"><img src="images/logo.png" alt="logo" style="margin-top:-15px;"></a>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 mb-1">
                        <div class="gallery-item">
                            ...
                            <div class="gallery-desc">
                                ...
                                <a class="image-popup" href="admin/images/class_room/<?php echo $result['class_room_image']; ?>" title="Photo Title Here">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="gallery-item">
                            ...
                            <div class="gallery-desc">
                                <!--<h3><a href="#">Photo Title Here</a></h3>-->
                                <!--<p>There are many variations of Lorem Ipsum available</p>-->
                                <a class="image-popup" href="admin/images/laboratory/<?php echo $result['laboratory_image']; ?>" title="Photo Title Here">
                                    <i class="fa fa-search"></i>
                                </a>
                            </div>
                        </div>
