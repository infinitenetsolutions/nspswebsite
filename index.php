						...
						?>
							...
							<div class="card">
								...
								<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
									<div class="card-body">
										<?php echo htmlspecialchars_decode($missionInformations->short_description); ?><a href="about.php">Read More...</a>
									</div>
								</div>
							</div>
						...
						?>
							...
							<div class="card">
								...
								<div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
									<div class="card-body">
										<?php echo htmlspecialchars_decode($visionInformations->short_description); ?><a href="about.php">Read More...</a></div>
								</div>
							</div>
