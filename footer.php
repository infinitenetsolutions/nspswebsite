...
PS : MGM, Dist : East Singhbhum, Jamshedpur - 832106 , Jharkhand
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-12">
                            <div class="about-widget">
                                ...
                                <p> It is being run in a spacious building with all necessary amenities and facilities available thereat. This school has been running classes from Lkg. to Std 10...<a href="about.php" style="color:red;">Read More...</a></p>
                        ...
                        <div class="col-lg-4 col-md-12">
                            ...
                            <ul class="sitemap-widget">
                                ...
                                <li><a href="principal_desk.php"><i class="fa fa-angle-right" aria-hidden="true"></i>Principal Desk.php</a></li>
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="copyright">
                        <p>© <?php echo date('Y')?> - <a href="http://infinitenetsolutions.com/" target="_blank" style="color:white;">Infinite Net Solutions</a> All Rights Reserved.</p>
                    </div>
                </div>
            </div>
        </footer>
